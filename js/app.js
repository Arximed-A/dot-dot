...
let tempChek = document.querySelector('.temperature__check-box');
let tempMenu = document.querySelector('.temperature__body');




tempChek.addEventListener("click", function (e) {
	tempChek.classList.toggle('_chek');
	tempMenu.classList.toggle('_active-temp');
});
